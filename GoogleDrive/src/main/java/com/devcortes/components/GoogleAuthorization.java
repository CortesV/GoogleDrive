...
public class GoogleAuthorization {
	...
	private static Logger log = Logger.getLogger(GoogleAuthorization.class);
	...
	/**
	 * Global instance of the scopes required by this GoogleApi.
	 *
	...
	public static Credential authorize() throws IOException {
		...
		log.error("Credentials saved to " + " " + DATA_STORE_DIR.getAbsolutePath());
		return credential;
	}
	...
	public static void setDATA_STORE_FACTORY(FileDataStoreFactory dATA_STORE_FACTORY) {
	...
	public static void setHTTP_TRANSPORT(HttpTransport hTTP_TRANSPORT) {
